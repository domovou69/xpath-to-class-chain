...
[![CI](https://github.com/domovou69/xpath-to-class-chain/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/domovou69/xpath-to-class-chain/actions/workflows/ci.yml)
